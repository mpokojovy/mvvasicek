...
time_grid_benchmark = datetime("7/1/2021", 'InputFormat', 'MM/dd/uuuu'):datetime("9/30/2021", 'InputFormat', 'MM/dd/uuuu');
...
US_rates_benchmark = interp1(US_dates, US_rates, time_grid_benchmark, 'linear', 'extrap');
EU_rates_benchmark = interp1(EU_dates, EU_rates, time_grid_benchmark, 'linear', 'extrap');

% Plot data
figure(1);
plot_short_rates(time_grid_historic, time_grid_benchmark, ...
...
R_bm   = [US_rates_benchmark; EU_rates_benchmark]';
...
%% Error comparison
figure(3);
plot_error_benchmarks(time_grid_benchmark, US_rates_benchmark, EU_rates_benchmark, ...
                      pred_0, pred_1)
